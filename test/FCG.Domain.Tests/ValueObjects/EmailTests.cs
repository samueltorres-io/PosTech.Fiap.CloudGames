...
public class EmailTests
{
    ...
    {
        var email = Email.Create("  User@FCG.COM  ");

        email.Value.Should().Be("user@fcg.com");
    }
    ...
    {
        Email.Create("user@fcg.com").Should().Be(Email.Create("USER@fcg.com"));
    }
}
