...
Funcionalidade: Autenticação de usuários
  ...
  Cenário: Cadastro com senha forte seguido de login bem-sucedido
    Dado que não existe usuário cadastrado com o e-mail "jogador@fcg.com"
    Quando eu cadastro o usuário "Jogador" com e-mail "jogador@fcg.com" e senha "Str0ng!Pass"
    Então o cadastro é realizado com sucesso
    E o login com e-mail "jogador@fcg.com" e senha "Str0ng!Pass" retorna um token válido

  Cenário: Cadastro com senha fraca é rejeitado
    Quando eu tento cadastrar o usuário "Fraco" com e-mail "fraco@fcg.com" e senha "123"
    Então o cadastro é rejeitado por senha inválida

  Cenário: Login com senha incorreta é negado
    Dado que existe um usuário "Maria" com e-mail "maria@fcg.com" e senha "Str0ng!Pass"
    Quando eu tento autenticar com e-mail "maria@fcg.com" e senha "SenhaErrada1!"
